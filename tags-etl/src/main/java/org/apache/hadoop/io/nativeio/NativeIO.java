...
public class NativeIO {
    ...
    public static class Windows {
         ...
         * {@link FileOutputStream}. The file is opened for truncate or append,
    ...
    public static FileInputStream getShareDeleteFileInputStream(File f, long seekOffset) throws IOException {
        if (!Shell.WINDOWS) {
            ...
            FileDescriptor fd = Windows.createFile(
                    f.getAbsolutePath(), Windows.GENERIC_READ, Windows.FILE_SHARE_READ
        ...
        if (!Shell.WINDOWS) {
            ...
            try {
                FileDescriptor fd = POSIX.open(f.getAbsolutePath(),
                        POSIX.O_WRONLY | POSIX.O_CREAT | POSIX.O_EXCL, permissions);
            ...
            try {
                FileDescriptor fd = Windows.createFile(
                        f.getCanonicalPath(), Windows.GENERIC_WRITE, Windows.FILE_SHARE_DELETE
